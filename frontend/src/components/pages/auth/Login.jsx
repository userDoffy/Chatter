...
import loginAnimation from '../../../assets/loginAnimation.json'; // You can replace this with a login-specific animation if desired
          ...
          >
            ...
            >
              <Card.Body>
                ...
                <Alert variant="danger" className="d-none">Invalid credentials</Alert>
